...
if(isset($_GET['e'])){
  switch ($_GET['e']) {
    ...
    case '2':$mensaje="<label class='animated fadeIn animate5' style='color:red;font-size:14px;margin-top:20px;'>ERROR DE USUARIO!</label><br>";break;
           ...
           <div class="panel shadow1">
                <form class="login-form" action="login.php" method="POST">
                    ...
                    <fieldset id="login-fieldset">
                        <input class="login animated fadeInUp animate2" name="username" type="text"  required   placeholder="Correo Cliente" value="" >
                        <input class="login animated fadeInUp animate3" name="password" type="password" required placeholder="Contraseña" value="">
                        <p class="animated fadeIn animate5" style="font-size: 10px;color:#fff">Si es la primera vez, la contraseña es el NIT</p>
                    ...
                    <input type="submit" id="login-form-submit" class="login_form button animated fadeInUp animate4" value="INGRESAR">
                    <p>
                      <!-- <a id="lost-password-link" href="#" onclick="window.location.href='recu.php';" class="animated fadeIn animate5" style="color:#fff">Olvide mi contraseña</a> -->                      
                    </p>                   
